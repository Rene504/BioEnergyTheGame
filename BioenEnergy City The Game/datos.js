...
const ZONAS = {
  nucleo: {
    ...
    quiz: {
      ...
      feedbackOk: "¡Correcto! El metabolismo es el motor de transformación de energía de la célula. ¡+20 ATP!",
  ...
  mitocondria: {
    ...
    quiz: {
      ...
      feedbackOk: "¡Exacto! El ATP es la 'electricidad' celular: energía lista para usar. ¡+25 ATP!",
  ...
  redox: {
    ...
    quiz: {
      ...
      feedbackOk: "¡Correcto! Oxidación = perder electrones. ¡La glucosa se oxida para liberar energía! ¡+30 ATP!",
